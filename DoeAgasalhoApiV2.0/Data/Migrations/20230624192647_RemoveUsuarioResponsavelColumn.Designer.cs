...
namespace DoeAgasalhoApiV2._0.Migrations
{
    ...
    [Migration("20230624192647_RemoveUsuarioResponsavelColumn")]
    partial class RemoveUsuarioResponsavelColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoeAgasalhoApiV2._0.Entities.Doacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DoeAgasalhoApiV2._0.Entities.Endereco", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DoeAgasalhoApiV2._0.Entities.PontoColeta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DoeAgasalhoApiV2._0.Entities.PontoProduto", b =>
                {
            ...
            modelBuilder.Entity("DoeAgasalhoApiV2._0.Entities.Produto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DoeAgasalhoApiV2._0.Entities.Tamanho", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DoeAgasalhoApiV2._0.Entities.Tipo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DoeAgasalhoApiV2._0.Entities.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DoeAgasalhoApiV2._0.Entities.Doacao", b =>
                {
                    b.HasOne("DoeAgasalhoApiV2._0.Entities.Produto", "Produto")
                        .WithMany("Doacoes")
                        .HasForeignKey("ProdutoId")
                        .IsRequired()
                        .HasConstraintName("fk_doacao_produto1");

                    b.HasOne("DoeAgasalhoApiV2._0.Entities.Usuario", "Usuario")
                        .WithMany("Doacoes")
            ...
            modelBuilder.Entity("DoeAgasalhoApiV2._0.Entities.PontoColeta", b =>
                {
                    b.HasOne("DoeAgasalhoApiV2._0.Entities.Endereco", "Endereco")
            ...
            modelBuilder.Entity("DoeAgasalhoApiV2._0.Entities.Produto", b =>
                {
                    b.HasOne("DoeAgasalhoApiV2._0.Entities.Tamanho", "Tamanho")
                        .WithMany("Produtos")
                        .HasForeignKey("TamanhoId")
                        .IsRequired()
                        .HasConstraintName("fk_produtos_tamanhos1");

                    b.HasOne("DoeAgasalhoApiV2._0.Entities.Tipo", "Tipo")
                        .WithMany("Produtos")
